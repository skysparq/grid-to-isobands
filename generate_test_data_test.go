...
func TestGenerateWindU100Hpa(t *testing.T) {
	t.Skip()
	err := generateTestData(
		"https://noaa-gfs-bdp-pds.s3.amazonaws.com/gfs.20251002/12/atmos/gfs.t12z.pgrb2.0p25.f022",
		"wind-u-100hpa.json",
...
func TestGenerateReflectivityAtmosphere(t *testing.T) {
	t.Skip()
	err := generateTestData(
		"https://noaa-gfs-bdp-pds.s3.amazonaws.com/gfs.20251002/12/atmos/gfs.t12z.pgrb2.0p25.f022",
		"reflectivity-atmosphere.json",
		9,
	)
	if err != nil {
		t.Fatal(err)
...
func TestGenerateCompositeReflectivity(t *testing.T) {
	t.Skip()
	err := generateTestData(
		`https://noaa-mrms-pds.s3.amazonaws.com/CONUS/MergedReflectivityComposite_00.50/20260107/MRMS_MergedReflectivityComposite_00.50_20260107-190236.grib2.gz`,
		`mrms-composite-reflectivity.json`,
		1,
	)
	if err != nil {
		t.Fatal(err)
